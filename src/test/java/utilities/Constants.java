...
public class Constants {
    ...
    public static String SUITE_XL_PATH = System.getProperty("user.home") + "/mobile-auto-test/src/test/resources/testdata/Suite.xlsx";
    public static String SUITE1_XL_PATH = System.getProperty("user.home") + "/mobile-auto-test/src/test/resources/testdata/TimelyTestSuite.xlsx";
