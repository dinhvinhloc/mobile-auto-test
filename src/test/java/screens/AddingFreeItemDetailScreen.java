...
public class AddingFreeItemDetailScreen extends ScreenBase {

    @AndroidFindBy(id = "add_on_selection_btn_add_product")
    public WebElement addToMyCartBtn;

    @AndroidFindBy(id = "add_on_selection_tv_price")
    public WebElement productCost;

    public AddingFreeItemDetailScreen(AppiumDriver<MobileElement> driver) {
        super(driver);
